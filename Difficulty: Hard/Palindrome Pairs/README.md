<h2><a href="https://www.geeksforgeeks.org/problems/palindrome-pairs/1?_gl=1*1uf12i2*_up*MQ..&gclid=CjwKCAjw-dfOBhAjEiwAq0RwI2nj_AUvECIUwelPpBxDjCm15Ss_bQOg4av1T_iRNTILuBLVfgNSDBoC6UQQAvD_BwE&gbraid=0AAAAAC9yBkACAf8RpLPUG28JDYS2e4QLX">Palindrome Pairs</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given&nbsp;</span><span style="font-size: 18px;">an array <strong>arr[]</strong> consisting of <strong>n </strong>strings. Determine whether there exists a pair of indices <strong>(i, j) </strong>such that <strong>i ≠ j </strong>and the concatenation <strong>arr[i] + arr[j]</strong> forms a palindrome.</span></p>
