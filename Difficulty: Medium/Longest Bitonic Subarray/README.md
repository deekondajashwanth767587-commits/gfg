<h2><a href="https://www.geeksforgeeks.org/problems/maximum-length-bitonic-subarray5730/1?_gl=1*1qfhla0*_up*MQ..&gclid=CjwKCAjw-dfOBhAjEiwAq0RwI2nj_AUvECIUwelPpBxDjCm15Ss_bQOg4av1T_iRNTILuBLVfgNSDBoC6UQQAvD_BwE&gbraid=0AAAAAC9yBkACAf8RpLPUG28JDYS2e4QLX">Longest Bitonic Subarray</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of size <strong>n</strong> containing positive integers, return the maximum length of the bitonic<strong> </strong>subarray.</span></p>
