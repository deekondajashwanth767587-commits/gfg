<h2><a href="https://www.geeksforgeeks.org/problems/construct-list-using-given-q-xor-queries/1?_gl=1*wtykov*_up*MQ..&gclid=CjwKCAjw-dfOBhAjEiwAq0RwI2nj_AUvECIUwelPpBxDjCm15Ss_bQOg4av1T_iRNTILuBLVfgNSDBoC6UQQAvD_BwE&gbraid=0AAAAAC9yBkACAf8RpLPUG28JDYS2e4QLX">Construct List using XOR Queries</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">There is an array that initially contains only a single value,&nbsp;<strong>0</strong>.&nbsp;</span></p>
