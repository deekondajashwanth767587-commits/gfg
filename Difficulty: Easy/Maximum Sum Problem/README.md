<h2><a href="https://www.geeksforgeeks.org/problems/maximum-sum-problem2211/1?_gl=1*1n9a1hk*_up*MQ..&gclid=CjwKCAjw-dfOBhAjEiwAq0RwI2nj_AUvECIUwelPpBxDjCm15Ss_bQOg4av1T_iRNTILuBLVfgNSDBoC6UQQAvD_BwE&gbraid=0AAAAAC9yBkACAf8RpLPUG28JDYS2e4QLX">Maximum Sum Problem</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p dir="ltr">Given a number&nbsp;<strong><strong>n, </strong></strong>find its maximum sum value with 3 recursive breaks described below.</p>
<ul>
