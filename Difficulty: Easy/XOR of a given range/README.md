<h2><a href="https://www.geeksforgeeks.org/problems/xor-of-a-given-range/1?page=2&category=Advanced%20Data%20Structure&sortBy=submissions">XOR of a given range</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">You are given an array nums. Your task is to complete the function&nbsp;<strong>getXor&nbsp;</strong>to return the XOR of the given range a and b.</span><br><span style="font-size: 14pt;">&nbsp;</span></p>
